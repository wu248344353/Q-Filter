...
def download_d4rl_data():
    ...
    # for dataset_type in ["medium-diverse-v2"]:
    # for dataset_type in ["umaze-v0", "umaze-diverse-v0", "medium-diverse-v0", "large-diverse-v0"]:
    # Ktichen-v0

    for env_name in ["maze2d"]:
        #     for dataset_type in ["complete-v0", "partial-v0", "mixed-v0"]:
        for dataset_type in ["open-v0", "open-dense", "umaze", "umaze-dense", "medium", "medium-dense", "large",
                             "large-dense"]:
            # for dataset_type in ["partial-v0"]:
